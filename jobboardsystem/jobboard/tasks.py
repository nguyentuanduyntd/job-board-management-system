...
def _build_html(app) -> str:
    ...
    if app.interview_map_url:
        map_info = f'<p style="margin: 4px 0;"><strong>Bản đồ địa điểm:</strong> <a href="{app.interview_map_url}" style="color: #2563EB; text-decoration: underline;">Nhấn vào đây để xem đường đi</a></p>'
...
<body style="margin: 0; padding: 24px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #1F2937; line-height: 1.6; background-color: #FFFFFF;">
    <div style="max-width: 600px; margin: 0 auto;">
        ...
        <p style="font-weight: 700; margin-top: 24px; color: #374151;"> Một số lưu ý quan trọng dành cho ứng viên khi đến tham gia phỏng vấn:</p>
